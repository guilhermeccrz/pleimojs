define(function(require){
    ...
    var ArtistEditProductsView = Backbone.View.extend({
        el: '#main',
            ...
            pleimo.product = {
                ...
                markup: {
                    ...
                    init: function() {
                        ...
                        $.post(base_url+"artist/edit/product/save_confirm", function(data){ pleimo.product.markup.$saveConfirm = $(data); });
                        $.post(base_url+"artist/edit/product/remove_confirm", function(data){ pleimo.product.markup.$removeConfirm = $(data); });
                    }
                },
                /**
                 * @method
                ...
                upload: {
                    init: function() {
                        ...
                        $("#stamp-upload").uploadify({
                            ...
                            'scriptAccess'    : 'always',
                            'wmode'		      : 'transparent',
                            'scriptData'      : { "ID_ARTIST" : pleimo.Session.get("ID_ARTIST") },
