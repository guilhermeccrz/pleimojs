    ...
    var CartPaymentView = Backbone.View.extend({
        ...
        addEvents: function(){
            ...
            $.get(base_url+'application/www/language/cart.xml', null, function (data, textStatus) {
                ...
                {
                    var tmp_date = new Date('month '+(parseInt($(evt.target).data('id'))+1));
                    tmp_date.setDate(0);
                    var last_day = tmp_date.getDate();
                ...
                $("#cart-payment").validate({
                    ...
                    submitHandler: function() {
                        $("#cart-payment .submit").data('callback', {
                            success: function(data) {
                                viewFactory.getView('cart/CartProcessView', function(view) {
                                    view.$el.html(data);
                                });
                            }
                        });
